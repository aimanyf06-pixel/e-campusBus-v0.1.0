...
<head>
    ...
    <title>My Profile - e-campusBus System</title>
    ...
    <div class="main-content">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="stat-box red">
                    ...
                    <h3>RM <?php echo number_format($stats['total_spent'] ?? 0, 0); ?></h3>
                    <p>Total Spent</p>
                </div>
            </div>
        </div>
        ...
        <div class="content-card">
            ...
            <div class="info-row">
                ...
                <span class="info-value">
                    <span class="badge" style="background-color: var(--accent-blue);">Student</span>
                </span>
            </div>
            <div class="info-row">
                <span class="info-label">Total Spent</span>
                <span class="info-value" style="font-weight: 700; color: var(--success-green);">
